...
class Admin extends AdminPage {
	...
	public function tabs( $current = 'introduction' ) {
		$tabs = array(
			'introduction' => esc_html__( 'Introduction', 'initiator' ),
		);
	...
	public function introduction() { ?>
		<h2 class="admin-title"><?php esc_html_e( 'Theme Info', 'initiator' ); ?></h2>
		<ul>
			<li><?php echo esc_html( __('Theme Name: ', 'initiator' ) . $this->theme_info->name ); ?></li>
			<li><?php echo esc_html( __('Theme Version: ', 'initiator' ) . $this->theme_info->version ); ?></li>
		</ul>
		<h2 class="admin-title"><?php esc_html_e( 'Welcome', 'initiator' ); ?></h2>
		<?php esc_html_e( 'Hope you are enjoying the theme. ', 'initiator' ); ?>
		<h2 class="admin-title"><?php esc_html_e( 'Recommended Plugins', 'initiator' ); ?></h2>
		<ul>
			<li><a href="<?php esc_url( 'https://wordpress.org/plugins/jetpack' ); ?>"><?php esc_html_e( 'Jetpack by WordPress.com', 'initiator' ); ?></a></li>
			<li><a href="<?php esc_url( 'https://wordpress.org/plugins/regenerate-thumbnails' ); ?>"><?php esc_html_e( 'Regenerate Thumbnails', 'initiator' ); ?></a></li>
		</ul>
	<?php }
