 ...
 */
function initiator_theme_setup() {
	/**
...
add_action( 'after_setup_theme', __NAMESPACE__ . '\initiator_theme_setup' );

/**
 * Add support for custom header.
 */
function initiator_custom_header() {
...
add_action( 'after_setup_theme', __NAMESPACE__ . '\initiator_custom_header' );

/**
 * Add Support Custom Background
 */
function initiator_custom_background() {
...
add_action( 'after_setup_theme', __NAMESPACE__ . '\initiator_custom_background' );